...
class DLA(nn.Module):
    ...
    def load_pretrained_model(self, data='imagenet', name='dla34', hash='ba72cf86'):
        ...
        model_weights = {k:v for k, v in model_weights.items() if k in self.state_dict().keys()}
...
def dla34(pretrained=True, **kwargs):  # DLA-34
    ...
    if pretrained:
        ...
        print("load dla34 pretrained model success in dla.py")
    return model
...
class DLASeg(nn.Module):
    def __init__(self, base_name, heads, pretrained, down_ratio, final_kernel, last_level, head_conv, out_channel=0, use_dcn=True):
