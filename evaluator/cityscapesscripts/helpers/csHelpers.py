...
# Cityscapes modules
try:
    from evaluator.cityscapesscripts.helpers.annotation import Annotation
    from evaluator.cityscapesscripts.helpers.labels import labels, name2label, id2label, trainId2label, category2labels
